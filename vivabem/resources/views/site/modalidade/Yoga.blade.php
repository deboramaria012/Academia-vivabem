           ...
           <div class="col-xxl-8 col-lg-7">
               <div class="service-page-single">
                   <div class="page-img mb-50">
                       <img src="{{ asset ('assets/img/yoga.png') }}" alt="img">
                   </div>
                   <div class="page-content">
                       <h2 class="page-title">Yoga</h2>
                       <p class="mb-50">A Yoga é inclusiva e adaptável, adequada para todas as idades e níveis de condicionamento físico. Cada praticante pode escolher um caminho que ressoe com sua natureza e objetivos pessoais.</p>
                       <p class="mb-30"> Além do tapete de Yoga, os benefícios se estendem para além do físico. A prática regular pode reduzir o estresse, melhorar a qualidade do sono, fortalecer o sistema imunológico e proporcionar uma sensação geral de bem-estar.</p>
