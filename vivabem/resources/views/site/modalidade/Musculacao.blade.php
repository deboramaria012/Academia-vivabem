           ...
           <div class="col-xxl-8 col-lg-7">
               <div class="service-page-single">
                   <div class="page-img mb-50">
                       <img src="{{ asset('assets/img/musculacao.png') }}" alt="img">
                   </div>
                   <div class="page-content">
                       <h2 class="page-title">Musculação</h2>
                       <p class="mb-30"> Aqui você encontrará informações valiosas sobre musculação, dicas de treino e estilo de vida saudável.</p>
                       <p class="mb-50">A musculação é uma ferramenta poderosa para transformar a composição corporal. Ao se engajar em treinos regulares, você não apenas constrói músculos fortes, mas também reduz a gordura corporal. Isso resulta não apenas em uma aparência mais tonificada, mas também em melhorias significativas na postura e equilíbrio.</p>
